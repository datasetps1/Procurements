...
namespace MVCWebAppServierCon.Migrations
{
    ...
    [Migration("20210224162518_update-analysis-table-2")]
    partial class updateanalysistable2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCWebAppServierCon.Models.Analysis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("SalesCriteriasId");

                    b.HasIndex("SalesQouteHeaderId");

                    b.HasIndex("SalesSuppliersId");
            ...
            modelBuilder.Entity("MVCWebAppServierCon.Models.SalesQouteHeader", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -4,
                            CreationDate = new DateTime(2021, 2, 24, 18, 25, 17, 91, DateTimeKind.Local).AddTicks(6548),
                        ...
                        {
                            Id = -3,
                            CreationDate = new DateTime(2021, 2, 24, 18, 25, 17, 95, DateTimeKind.Local).AddTicks(2225),
                        ...
                        {
                            Id = -2,
                            CreationDate = new DateTime(2021, 2, 24, 18, 25, 17, 95, DateTimeKind.Local).AddTicks(2264),
                            ExpierDate = new DateTime(2022, 10, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfferDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfferName = "something"
                        },
                        ...
                        {
                            Id = -1,
                            CreationDate = new DateTime(2021, 2, 24, 18, 25, 17, 95, DateTimeKind.Local).AddTicks(2269),
                            ExpierDate = new DateTime(2022, 10, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfferDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("MVCWebAppServierCon.Models.Analysis", b =>
                {
                    b.HasOne("MVCWebAppServierCon.Models.SalesCriterias", "salesCriterias")
                        .WithMany()
                        .HasForeignKey("SalesCriteriasId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MVCWebAppServierCon.Models.SalesQouteHeader", "Header")
                        .WithMany()
                        .HasForeignKey("SalesQouteHeaderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MVCWebAppServierCon.Models.SalesSuppliers", "salesSuppliers")
                        .WithMany()
                        .HasForeignKey("SalesSuppliersId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
